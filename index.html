...
<!-- Mirrored from www.wrraptheme.com/templates/compass/estate/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 31 Dec 2022 10:06:35 GMT -->
<head>
<meta charset="utf-8">
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Estate</strong> Annual Report</h2>
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card">
                    <div class="header">
                        <h2><strong>Rent</strong> Income<small>18% High then last month</small></h2>
                        <ul class="header-dropdown">
                            <li class="dropdown"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <i class="zmdi zmdi-more"></i> </a>
                                <ul class="dropdown-menu dropdown-menu-right slideUp">
                                    <li><a href="javascript:void(0);">Action</a></li>
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="row stats-report">
                            <div class="col-4">
                                <p class="m-b-0">Overall</p>
                                <b class="col-amber">45.40%</b>
                            </div>
                            <div class="col-4">
                                <p class="m-b-0">Montly</p>
                                <b class="col-amber">68.80%</b>
                            </div>
                            <div class="col-4">
                                <p class="m-b-0">Day</p>
...
<!-- Mirrored from www.wrraptheme.com/templates/compass/estate/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 31 Dec 2022 10:07:18 GMT -->
</html>