...
<!-- Mirrored from www.wrraptheme.com/templates/compass/estate/search-results.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 31 Dec 2022 10:08:23 GMT -->
<head>
<meta charset="utf-8">
        ...
        <ul class="list">
            ...
            <li class="active open"> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-copy"></i><span>Sample Pages</span> </a>
                <ul class="ml-menu">
                    ...
                    <liclass="active"><a href="search-results.html">Search Results</a></li>
                </ul>
            </li>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">                    
                    <div class="body">
                        ...
                        <div class="">
                            <p>Popular Search:</p>
                            <span class="badge badge-default">Resent Email</span>
                            <span class="badge badge-primary">Meeting</span>
                            <span class="badge badge-success">Timeline Activity</span>
                            <span class="badge badge-info">Info</span>
                            <span class="badge badge-warning">New Project</span>
                        </div>
                    </div>
                </div>                
            </div>
            <div class="col-md-12">
                <div class="card">
                    <div class="body">
                        <h6 class="m-t-0"><a href="javascript:void(0);">Form Elements</a></h6>
                        <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.</p>
                        <a href="javascript:void(0);">http://compass.com/lorem/form-elements.html</a>
                    </div>
                </div>
                <div class="card">
                    <div class="body">
