...
<!-- Mirrored from www.wrraptheme.com/templates/compass/estate/map.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 31 Dec 2022 10:07:54 GMT -->
<head>
<meta charset="utf-8">
...
<aside id="leftsidebar" class="sidebar">
    <div class="menu">
        <ul class="list">
            ...
            <li class="active open"><a href="map.html"><i class="zmdi zmdi-pin"></i><span>Map</span></a></li>
        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6 col-sm-12">
                <ul class="breadcrumb float-md-right">
                    ...
                    <li class="breadcrumb-item active">Site Location</li>
                </ul>
            </div>
        </div>
    </div>
