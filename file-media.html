...
<!-- Mirrored from www.wrraptheme.com/templates/compass/estate/file-media.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 31 Dec 2022 10:08:33 GMT -->
<head>
<meta charset="utf-8">
...
<aside id="leftsidebar" class="sidebar">
    <div class="menu">
        <ul class="list">
            ...
            <li class="active open"><a href="file-media.html" ><i class="zmdi zmdi-collection-video"></i><span>Media</span></a></li>
    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#2017">2017</a></li>
