...
<!-- Mirrored from www.wrraptheme.com/templates/compass/estate/property-list4.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 31 Dec 2022 10:07:47 GMT -->
<head>
<meta charset="utf-8">
        ...
        <ul class="list">
            ...
            <li class="active open"><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-city"></i><span>Property</span> </a>
                <ul class="ml-menu">
                    ...
                    <li class="active"><a href="property-list4.html">4 Column</a></li>                        
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="card property_list">
                    <div class="property_image">
                        <img class="img-thumbnail img-fluid" src="assets/images/image-gallery/7.jpg" alt="img">
                        <span class="badge badge-danger">For Sale</span>
                    </div>
                    <div class="body">
                        <div class="property-content">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="card property_list">
                    <div class="property_image">
                        <img class="img-thumbnail img-fluid" src="assets/images/image-gallery/8.jpg" alt="img">
                        <span class="badge badge-warning">For Rent</span>
                    </div>
                    <div class="body">
                        <div class="property-content">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="card property_list">
                    <div class="property_image">
                        <img class="img-thumbnail img-fluid" src="assets/images/image-gallery/9.jpg" alt="img">
                        <span class="badge badge-danger">For Sale</span>
                    </div>
                    <div class="body">
                        <div class="property-content">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="card property_list">
                    <div class="property_image">
                        <img class="img-thumbnail img-fluid" src="assets/images/image-gallery/10.jpg" alt="img">
                        <span class="badge badge-danger">For Sale</span>
                    </div>
                    <div class="body">
                        <div class="property-content">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="card property_list">
                    <div class="property_image">
                        <img class="img-thumbnail img-fluid" src="assets/images/image-gallery/11.jpg" alt="img">
                        <span class="badge badge-danger">For Sale</span>
                    </div>
                    <div class="body">
                        <div class="property-content">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="card property_list">
                    <div class="property_image">
                        <img class="img-thumbnail img-fluid" src="assets/images/image-gallery/12.jpg" alt="img">
                        <span class="badge badge-danger">For Sale</span>
                    </div>
                    <div class="body">
                        <div class="property-content">
...
<!-- Mirrored from www.wrraptheme.com/templates/compass/estate/property-list4.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 31 Dec 2022 10:07:50 GMT -->
</html>