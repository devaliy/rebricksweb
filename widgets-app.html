...
<!-- Mirrored from www.wrraptheme.com/templates/compass/estate/widgets-app.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 31 Dec 2022 10:08:04 GMT -->
<head>
<meta charset="utf-8">
    ...
    <div class="menu">
        <ul class="list">
            ...
            <li class="active open"> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-delicious"></i><span>Widgets</span> </a>
                <ul class="ml-menu">
                    <li class="active"><a href="widgets-app.html">Apps Widgetse</a></li>
    ...
    <div class="container-fluid">        
        <div class="row clearfix">
            ...
            <div class="col-md-12 col-lg-4">
                <div class="card">
                    <div class="header">
                        <h2><strong>New</strong> Friends</h2>
                    </div>
                    <div class="body">
        ...
        <div class="row clearfix">
            <div class="col-md-12">
                <div class="card-group text-center">
                    ...
                    <div class="card">
                        <img class="img-fluid" src="assets/images/image3.jpg" alt="Card image cap">
                        <div class="body">
                            <h4 class="title">Card title</h4>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <a href="#" class="btn btn-primary btn-round waves-effect">Button</a>
                            <p class="text">
                            <small class="text-muted">Last updated 3 mins ago</small>
                            </p>
                        </div>
        ...
        <div class="row clearfix">
            <div class="col-lg-4 col-md-12">
                <div class="card project_widget">
                        <div class="pw_img">
                        <img class="img-responsive" src="assets/images/image2.jpg" alt="About the image">
                    </div>
                    <div class="pw_content">
                        <div class="pw_header">
                            <h6>Magazine Design</h6>
                            <small class="text-muted">Compass  |  Last Update: 12 Dec 2017</small>
                        </div>
                        <div class="pw_meta">
                            <span>4,870 USD</span>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="card project_widget">
                    ...
                    <div class="pw_content">
                        <div class="pw_header">
                            <h6>New Dashboard</h6>
                            <small class="text-muted">Compass  |  Last Update: 17 Dec 2017</small>
                        </div>
                        <div class="pw_meta">
                            <span>921 USD</span>
                            <small class="text-muted">Budget / Salary</small>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="card project_widget">
                    ...
                    <div class="pw_content">
                        <div class="pw_header">
                            <h6>Mobile App</h6>
                            <small class="text-muted">Compass  |  Last Update: 21 Dec 2017</small>
                        </div>
                        <div class="pw_meta">
                            <span>1,870 USD</span>
                            <small class="text-muted">Budget / Salary</small>
...
<!-- Mirrored from www.wrraptheme.com/templates/compass/estate/widgets-app.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 31 Dec 2022 10:08:05 GMT -->
</html>