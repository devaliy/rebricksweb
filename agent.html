...
<!-- Mirrored from www.wrraptheme.com/templates/compass/estate/agent.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 31 Dec 2022 10:07:53 GMT -->
<head>
<meta charset="utf-8">
...
<aside id="leftsidebar" class="sidebar">
    <div class="menu">
        <ul class="list">
            ...
            <li class="active open"><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-accounts-outline"></i><span>Agents</span> </a>
                <ul class="ml-menu">
                    <li class="active"><a href="agent.html">All Agents</a></li>
        ...
        <div class="row clearfix">
            <div class="col-lg-4 col-md-6">
                <div class="card agent">
                    <div class="agent-avatar"> <a href="profile.html"> <img src="assets/images/lg/avatar1.jpg" class="img-fluid " alt=""> </a> </div>
                    <div class="agent-content">
                        <div class="agent-name">
                            <h4><a href="profile.html">Tim Hank</a></h4>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card agent">
                    <div class="agent-avatar"> <a href="profile.html"> <img src="assets/images/lg/avatar2.jpg" class="img-fluid " alt=""> </a> </div>
                    <div class="agent-content">
                        <div class="agent-name">
                            <h4><a href="profile.html">Gary Camara</a></h4>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card agent">
                    <div class="agent-avatar"> <a href="profile.html"> <img src="assets/images/lg/avatar3.jpg" class="img-fluid " alt=""> </a> </div>
                    <div class="agent-content">
                        <div class="agent-name">
                            <h4><a href="profile.html">Hossein Shams</a></h4>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card agent">
                    <div class="agent-avatar"> <a href="profile.html"> <img src="assets/images/lg/avatar4.jpg" class="img-fluid " alt=""> </a> </div>
                    <div class="agent-content">
                        <div class="agent-name">
                            <h4><a href="profile.html">Tom Wilson</a></h4>
