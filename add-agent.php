...
<!-- Mirrored from www.wrraptheme.com/templates/compass/estate/add-agent.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 31 Dec 2022 10:07:53 GMT -->
<head>
<meta charset="utf-8">
        ...
        <ul class="list">
            ...
            <li class="active open"><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-accounts-outline"></i><span>Agents</span> </a>
                <ul class="ml-menu">
                    ...
                    <li class="active"><a href="add-agent.html">Add Agent</a></li>                       
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <form action="https://www.wrraptheme.com/" id="frmFileUpload" class="dropzone" method="post" enctype="multipart/form-data">
