...
<!-- Mirrored from www.wrraptheme.com/templates/compass/estate/widgets-data.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 31 Dec 2022 10:08:05 GMT -->
<head>
<meta charset="utf-8">
        ...
        <ul class="list">
            ...
            <li  class="active open"> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-delicious"></i><span>Widgets</span> </a>
                <ul class="ml-menu">
                    ...
                    <li class="active"><a href="widgets-data.html">Data Widgetse</a></li>
                </ul>
            </li>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card">
                    <div class="header">
                        <h2><strong>Canada</strong> Sales Report</h2>
                    </div>
                    <div class="body">
                        <div class="row">
                            <div class="col-sm-4 col-4 m-b-10">
...
<!-- Mirrored from www.wrraptheme.com/templates/compass/estate/widgets-data.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 31 Dec 2022 10:08:06 GMT -->
</html>